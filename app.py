...
<main>
  ...
  <div class="stance">
    <div class="wrap">
      <p class="big">売買仲介の現場にいる人間が、<br>それでも物件を売らずに作っています。</p>
      <p>作っているのは宅地建物取引士で、住宅の売買仲介を6年やっています。
       だからこそ、販売図面に書かれていないことの多さを知っています。<br>
       HOME INDEX では物件の仲介をしません。仲介手数料も紹介料も受け取らず、
       特定の物件や業者に誘導することもありません。だから点数を上げる理由も、
       下げる理由もありません。
...
_ABOUT_BODY = ("""
<p class="sub">HOME INDEX は、個人が作って運営しているサービスです。</p>

<h2>作っている人</h2>
<p><b>""" + OPERATOR + """</b><br>
宅地建物取引士。住宅の売買仲介の実務に6年携わっています。</p>
<p>宅地建物取引業者に勤務していますが、<b>本サービスは勤務先とは無関係の、
個人の活動</b>です。勤務先の業務でも、勤務先の情報を使ったものでもありません。</p>

<h2>なぜ作ったか</h2>
<p>仲介の現場にいると、買う人が手にしている材料の少なさが見えます。
販売図面に載っているのは、価格・面積・築年・駅からの距離といった、
ごく限られた項目です。その物件が近隣の成約と比べて高いのか安いのか、
その土地に災害の想定があるのか、20年後にその地域に人が住んでいるのか。
どれも公開されているのに、検討している人の手元には届いていません。</p>
<p>「人気の物件です」と言われて、確かめようがないまま数千万円を決める。
その状態を、公的データで少しでも埋められないかと思って作りました。</p>

<h2>このサービスがしないこと</h2>
<ul>
<li><b>物件を売りません。</b>仲介も媒介もしません</li>
<li><b>仲介手数料も紹介料も受け取りません。</b>特定の物件・業者・金融機関へ
 誘導することもありません</li>
<li><b>点数を人の判断で動かしません。</b>配点は公開したルールのとおりで、
 診断のたびに手を入れることはありません</li>
<li><b>業者間の情報は使いません。</b>使っているのは、誰でも参照できる
 公的データだけです</li>
</ul>

<h2>使っているデータ</h2>
<p>国土交通省 不動産情報ライブラリ（成約価格・災害リスク・用途地域・学区・
将来推計人口）、国土地理院（住所から座標の特定）、OpenStreetMap（商業施設）。
出典は結果画面にも表示しています。</p>
<p>取得できなかった項目は「未取得」と表示し、点数には入れません。
埋めた振りをしないことを、設計の前提にしています。</p>

<h2>お問い合わせ</h2>
<p>""" + CONTACT + """</p>
<p class="sub">診断結果についてのご意見・間違いのご指摘は歓迎します。
公的データの読み違いがあれば直します。</p>
""")
...
_ABOUT_JSONLD = (
    ...
    '"description":"住宅の売買仲介の実務に6年携わる宅地建物取引士。"}}'
    '</script>')
