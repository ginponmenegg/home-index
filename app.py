...
<div class="wrap">
 ...
 <p class="aim">分かる範囲で答えるほど、診断の確かさが上がります。
  ...
  答えられなかったことは、最後に「仲介業者に聞くこと」としてまとめてお渡しします。
  あわせて「重要事項説明書の、どこを見るか」も出ます。</p>
 TRIAL_BANNER_PLACEHOLDER
 <div class="banner">
...
<div class="card">
 ...
 <p>答えられなかった項目は<b>「仲介業者に聞くこと」</b>の一覧になり、
  あわせて<b>「重要事項説明書の、どこを見るか」</b>が、根拠の条文つきで出ます。
  諸費用・金利・繰上返済・住宅ローン控除まで含めた資金計画と、
  これらをまとめたPDFもご利用いただけます。</p>
...
<div class="card" style="margin-top:14px">
 ...
 <p class="sub" style="margin-top:10px">
  ...
  資金計画のPDFには、この診断の点数・カテゴリ別の評価・重大リスク・
  重要事項説明書で確認することも入ります。{% endif %}</p>
</div>
{% endif %}
   ...
   <tr><th class="rowlbl">内容</th>
    <td>HOME INDEX PRO<br>
     <span class="sub">契約期間中、詳細診断・仲介業者に聞くことの一覧・
      重要事項説明書で確認することの一覧・資金計画のPDFを
      ご利用いただけます。診断の回数に制限はありません。
...
<p>あわせて、<b>「重要事項説明書の、どこを見るか」</b>が出ます。重要事項説明書は
契約の直前に渡され、その場で読み上げられます。30ページ近いものを初めて見て、
聞きながら判断するのは無理があります。診断で分かったこと（市街化調整区域か、
ハザードの区域に入るか、旧耐震か、区分所有か）から、<b>この物件で特に効く欄</b>を
根拠の条文つきで先に並べます。読む場所を絞っておくためのものです。</p>
<p class="sub">良し悪しは書きません。どこに何が書かれるかまでです。</p>
